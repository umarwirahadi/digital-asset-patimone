    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><a href="{{ route('options.index') }}" class="btn btn-link text text-danger"><i
                ...
                <form action="{{ route('options.store') }}" method="POST">
                    ...
                    <div class="card-body card-height">
                        <div class="row">
                            <div class="col-12">
                                <div class="row mb-3">
                                    <label for="option_name" class="col-sm-3 col-form-label">Name</label>
                                    <div class="col-sm-9">
                                        <input type="text"
                                            class="form-control @error('option_name') is-invalid @enderror"
                                            id="option_name" name="option_name" value="{{ old('option_name') }}">
                                        @error('option_name')
                                ...
                                <div class="row mb-3">
                                    <label for="option_value" class="col-sm-3 col-form-label">Value</label>
                                    <div class="col-sm-9">
                                        <input type="text"
                                ...
                                <div class="row mb-3">
                                    <label for="option_type" class="col-sm-3 col-form-label">Type</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    <label for="option_group" class="col-sm-3 col-form-label">Group</label>
                                    <div class="col-sm-9">
                                        <select name="option_group" id="option_group" class="form-select">
