                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <textarea disabled class="form-control"
                                        rows="5">{{ $data['image']->product->code }} - {{ $data['image']->product->name }} - {{ $data['image']->product->quantity }} - {{ $data['image']->product->description }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="description" class="form-control" rows="5">{{ $data['image']->description }}</textarea>
                                </div>
                            </div>
                            <div class="row mt-3">
                        ...
                        <div class="col-6">
                            <div class="card">
                                @if($data['image']->product_url)
                                <img src="{{ asset($data['image']->image_url) }}" alt="" class="img-thumbnail img-fluid" id="imageUserPreview"
                                style="width: 700px; height:500px;object-fit: fit; aspect-ratio: 3/2;">
                                @else
                                <img src="{{ asset('statics/img/product.png') }}" alt="" class="img-thumbnail img-fluid" id="imageUserPreview"
                                style="width: 700px; height:500px;object-fit: fit; aspect-ratio: 3/2;">
                                @endif
